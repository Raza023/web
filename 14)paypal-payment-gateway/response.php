...
try {
    ...
    try {
        ...
        if (addPayment($data) !== false && $data['payment_status'] === 'approved') {
            ...
            header("location:https://jscode.unaux.com/code/12)paypal-payment-gateway/PaypalSuccess.php?payid=$inserids");
            exit(1);
        } else {
            // Payment failed
			header("location:https://jscode.unaux.com/code/12)paypal-payment-gateway/PaypalFailed.php");
             exit(1);
        }
